...
general_don = [
    {"name": "Expertise du combat",
        "description": "1 -> 5 maluse de jet de jet et bonus à la CA"},
    {"name": "Science du croque en jambe",
        "description": "+4 au test de croc en jambe"},
    {"name": "Attaque en puissance",
        "description": "1 -> Niveau global du perso : bonus de dégât et malus au jet d'attaque"},
    {"name": "Arme de prédilection (épée bâtarde)",
     "description": "+1 au jet d'attaque lorsque équipée de l'épée bâtarde"},
    ...
    {"name": "Bouclier Divin",
        "description": "Action simple, sacrifie un renvoie de mort-vivant pour ajouter modif charisme à la CA"},
]
...
class_aptitude = {
    ...
    "rodeur": {
        ...
        "aptitudes": [
            ...
            {"name": "Maniement à deux armes",
                "description": "Peut se battre avec deux armes avec malus réduit"},
            {"name": "ennemi juré(créature magique)",
             "description": "bonus +2 dégât, bluff, perception auditive, psychologie, survie, détection"},
    ...
    "paladin_of_freedom": {
        "name": "Paladin de la liberté", "aptitudes": [
            ...
            {"name": "Aura de détermination",
                "description": "Immunité contre coerciction, +4 moral au alliées contre ceux-ci"},
            {"name": "Santé divine", "description": "Immuité contre les maladies"},
            {"name": "Destrier", "description": "Peut appeler un Destrier"},
            {"name": "Renvoie de mort vivant",
                "description": "Peut renvoyer les morts vivants 3+2+1 = 6 par jour"},
        ]},
    ...
    "guerrier_lupide": {"name": "Guerrier lupidé", "aptitudes": [
        ...
        {"name": "Transformation lupidé (Jeune Loup Artique taille M)",
         "description": "Lors d'une utilisation de rage, For +6, Con +4, Vol +2"},
    ]}
